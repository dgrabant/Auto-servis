document.getElementById('category-select').addEventListener('change', function() {
    ...
    if (selectedCategory === "all") {
        present_pict.src = "../../../public/assets/pictures/default_present.jpg";
    } else {
        present_pict.src = `pictures/${selectedImage}_present.jpg`; // Postavljanje slike iz foldera pictures
    }
